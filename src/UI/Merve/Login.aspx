...
<body style="background-image:url(images1.jpg); background-repeat:no-repeat"  >
   ...
   <div id="bg"></div>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <asp:TextBox ID="txtUsername" runat="server" BorderStyle="Dotted" BorderColor="White"></asp:TextBox>
        ...
        <br />
        <asp:TextBox ID="txtPassword" runat="server"  TextMode="Password" BorderColor="White" BorderStyle="Double"></asp:TextBox>
...
&nbsp;
  ...
  <asp:Button ID="btnLogin" runat="server" OnClick="btnLogin_Click" Text="Login" Width="200px" ValidationGroup="login" BorderColor="White" BorderStyle="Double" />
        <br />
        <asp:CheckBox ID="cbRememberMe" runat="server" Text="Remember Me" ForeColor="White" TextAlign="Left" />
        <br />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DenemeRegister.aspx" ForeColor="White">Go to Register</asp:HyperLink>
        <br />
        <br />

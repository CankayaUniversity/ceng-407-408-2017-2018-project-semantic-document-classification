...
<body style="background-image:url(images1.jpg);">
    <form runat="server" style="background-color:transparent; width: 1185px; margin-left: 442px;">
      <div style="margin-left: 0px">&nbsp;<asp:Label ID="lblReservation" runat="server" Font-Bold="True" Text="REGISTRATION" Font-Size="35pt" Font-Underline="True" ForeColor="White"></asp:Label></div>
          ...
          <br />
          <br />
          <asp:Label ID="lblSurname" runat="server" Text="Surname:" Font-Bold="True" ForeColor="White"></asp:Label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBoxSurname" runat="server" placeholder="Surname" ></asp:TextBox>
          <br />
          <br />
          <asp:Label ID="lblCity" runat="server" Text="City:" Font-Bold="True" ForeColor="White"></asp:Label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBoxCity" runat="server" placeholder="City" ></asp:TextBox>
          <br />
          <br />
        <asp:Label ID="lblPhone" runat="server" Text="Phone:" Font-Bold="True" ForeColor="White"></asp:Label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:TextBox ID="TextBoxPassword" TextMode="Password" runat="server" placeholder="Password"></asp:TextBox>
          <br />
          <br />
          <asp:Label ID="lblPasswordRepeat" runat="server" Text="Password(Repeat):" Font-Bold="True" ForeColor="White"></asp:Label>
          &nbsp;
        <asp:TextBox ID="TextBoxPasswordCheck" TextMode="Password" runat="server" placeholder="Password Again"></asp:TextBox>
          ...
          <br />
          <br />
          <asp:CompareValidator ID="CompareValidatorPassword" runat="server" ErrorMessage="Passwords don't match!" ControlToCompare="TextBoxPasswordCheck" ControlToValidate="TextBoxPassword" ForeColor="White"></asp:CompareValidator>
          <br />
